package com.AppLockDemo;

import java.util.List;



import com.AppLockDemo.db.dao.AppLockDao;
import com.AppLockDemo.domain.AppInfo;
import com.AppLockDemo.engine.AppInfoProvider;
import com.AppLockDemo.service.WatchDogService;
...
public class AppLockActivity extends Activity {
	...
	/*public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		{
			new AlertDialog.Builder(this).setTitle(R.string.exittitle).setMessage(R.string.exitinfo)
